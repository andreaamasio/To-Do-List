...
const modifyButtonExample = document.querySelector(
  "#today > div.project-header > button.modify-project-name.today"
)
...
export function modifyProjectName(e) {
  ...
  projectTarget.name = prompt(
    "How do you want to rename the project?",
    projectTarget.name
  )
  let divProjectTitle = document.querySelector(
    `div#${projectID} p.project-title`
  )
